...
def benchmark_shadow_latency(
    *,
    ...
    shadow_cfg = ShadowConfig(model=model, dtype=dtype, block_size=block_size)
    ...
    try:
        ...
        def _reset_batch() -> None:
            for rid in list(kv_state.request_ids()):
