...
from .shadow_migration import ShadowMigrationConfig
...
class VllmConfig:
    ...
    shadow_migration_config: ShadowMigrationConfig = Field(
        default_factory=ShadowMigrationConfig
    )
    """Serverless shadow KV migration (hot GPU → cold shadow CPU)."""
