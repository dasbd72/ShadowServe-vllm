...
from vllm.shadow.transfer.tksth_protocol import TksthFinishReason
...
) -> TksthFinishReason | None:
    """If generation should end after ``token_id``, return TKSTH ``finish_reason``.
